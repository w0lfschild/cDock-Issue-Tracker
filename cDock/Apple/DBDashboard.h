...
- (id)_processForWidget:(id)arg1 groupBy:(int)arg2 startBackgrounded:(_Bool)arg3;
...
- (void)_handleWidgetDownloadGURL:(struct __CFURL *)arg1;
...
- (void)_hotKeyUp:(id)arg1 slow:(_Bool)arg2;
- (void)_hotKeyDown:(id)arg1 slow:(_Bool)arg2;
- (void)_handleEvents;
...
- (id)addWidgetAndShowFromRef:(struct FSRef *)arg1 showDefaultBackground:(_Bool)arg2 position:(const struct CGPoint *)arg3;
...
- (_Bool)createAnOpenWidgetForSelfTest:(const char *)arg1;
- (void)springboardExited;
- (void)springboardEntered;
- (void)spaceWillBeHidden;
- (void)spaceWillBeShown;
- (short)openHandler:(const struct AEDesc *)arg1 reply:(struct AEDesc *)arg2 refCon:(long long)arg3;
...
- (void)invalidate;
- (void)dealloc;
- (id)initWithUberConnection:(unsigned int)arg1 enabledState:(int)arg2;
