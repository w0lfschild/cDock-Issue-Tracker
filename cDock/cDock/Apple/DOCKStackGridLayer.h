...
#import "ECScrollbarHandler.h"

@class CALayer, DOCKGridLayer, DOCKStackExpandedItemLayer, ECCartoucheBackdropLayer, ECScrollbarLayer, ECTextLayer, NSObject<OS_dispatch_source>, NSString, _DOCKStackGridHoverLayer, _ECDividerLineLayer, _ECVibrantTextLayer;
