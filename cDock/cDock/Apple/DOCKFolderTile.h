...
#import "DOCKDownloadProgressHandler.h"
...
- (id)copyTilePlist;
- (void)_init;
- (id)initWithPlist:(id)arg1 GUID:(unsigned int)arg2 isStatic:(BOOL)arg3 differentLocalization:(BOOL)arg4 anyStaticsEver:(BOOL)arg5;
